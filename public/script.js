...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            // Le formulaire est géré par Netlify, pas besoin de preventDefault()
            // Les données seront envoyées automatiquement grâce à l'attribut data-netlify="true"
            
            // On peut quand même ajouter un feedback visuel
